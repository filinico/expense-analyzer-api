...
ActiveRecord::Schema.define(version: 2021_11_12_102719) do
  ...
  create_table "articles", force: :cascade do |t|
    ...
    t.index ["weight_type_id"], name: "index_articles_on_weight_type_id"
  end
  ...
  create_table "weight_types", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end
  ...
  add_foreign_key "articles", "receipts"
  add_foreign_key "articles", "weight_types"
